...
WebUI.setText(findTestObject('Object Repository/Login/Page_META.vn - Mua sm trc tuyn/input_form-input form-u actived'), '0332427573')

WebUI.setEncryptedText(findTestObject('Object Repository/Login/Page_META.vn - Mua sm trc tuyn/input_form-input form-p'), 'Evr8jbf0RWRtfNjExVaakg==')
