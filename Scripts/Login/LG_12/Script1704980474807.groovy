...
WebUI.setText(findTestObject('Object Repository/Login/Page_META.vn - Mua sm trc tuyn/input_form-input form-u actived'), 'phuong.zorum24@student.passerelles numeriques.org')
