...
WebUI.click(findTestObject('Object Repository/Shopping_Cart/ADD001/Page_Mua hng online, Mua sm trc tuyn gi tt nht (1)/li_Tr gp490KMy git Samsung'))

WebUI.click(findTestObject('Object Repository/Login/Page_My nho bt Gourmetmaxx SM-1504 (5 lt, 1_3dfe4d/button_'))

WebUI.click(findTestObject('Object Repository/Login/Page_My nho bt Gourmetmaxx SM-1504 (5 lt, 1_d195ff/a_Cho vo gi'))

WebUI.click(findTestObject('Object Repository/Login/Page_My nho bt Gourmetmaxx SM-1504 (5 lt, 1_d195ff/i_fa fa-shopping-cart'))
