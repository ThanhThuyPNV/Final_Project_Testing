...
WebUI.click(findTestObject('Object Repository/Login/Page_META.vn - Mua sm trc tuyn/div_H v TnS in thoia chTnhThnh phTnhThnh ph_d5854a'))

WebUI.setText(findTestObject('Object Repository/Login/Page_META.vn - Mua sm trc tuyn/input_phone'), '0374878213')
...
WebUI.click(findTestObject('Object Repository/Login/Page_META.vn - Mua sm trc tuyn/div_Mua trc tr sau - BNPL'))

WebUI.click(findTestObject('Object Repository/Login/Page_META.vn - Mua sm trc tuyn/span_bank-logo bnpl-logo'))
