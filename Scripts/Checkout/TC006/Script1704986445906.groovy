...
WebUI.setText(findTestObject('Object Repository/Login/Page_META.vn - Mua sm trc tuyn/input_phone'), '9834762812')
...
WebUI.click(findTestObject('Object Repository/Login/Page_META.vn - Mua sm trc tuyn/div_Chuyn khon qua Ngn hng'))

WebUI.click(findTestObject('Object Repository/Login/Page_META.vn - Mua sm trc tuyn/img'))

WebUI.click(findTestObject('Object Repository/Login/Page_META.vn - Mua sm trc tuyn/div_bank-item selected'))
